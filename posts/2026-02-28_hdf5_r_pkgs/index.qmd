...
* **Immediate Alternatives:** If you need these formats today, `h5lite` can utilize external plugins. You can point the `HDF5_PLUGIN_PATH` environment variable to the plugin directories provided by Bioconductor's [**`rhdf5filters`**](https://bioconductor.org/packages/release/bioc/html/rhdf5filters.html) package.
